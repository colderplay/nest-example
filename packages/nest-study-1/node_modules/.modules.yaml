...
hoistedDependencies:
  ...
  /@angular-devkit/core/16.0.1_chokidar@3.5.3:
    '@angular-devkit/core': private
  /@angular-devkit/schematics-cli/16.0.1_chokidar@3.5.3:
    '@angular-devkit/schematics-cli': private
  /@angular-devkit/schematics/16.0.1_chokidar@3.5.3:
  ...
  /flatted/3.2.7:
    flatted: private
  /fork-ts-checker-webpack-plugin/8.0.0_hybrf64lftnf5l2xwgg7goi2iu:
  ...
  /jest-circus/29.5.0:
    jest-circus: private
  /jest-cli/29.5.0_jfk27zzpxfjmibypqi22cmssme:
    jest-cli: private
  /jest-config/29.5.0_jfk27zzpxfjmibypqi22cmssme:
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
  ...
  /tapable/2.2.1:
    tapable: private
  /terser-webpack-plugin/5.3.9_webpack@5.82.1:
...
pendingBuilds: []
prunedAt: Wed, 24 May 2023 11:17:43 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
  default: http://npm.zmops.cc/
skipped: []
storeDir: /Users/wzy/Library/pnpm/store/v3
